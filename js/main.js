...
var swiperText = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](_vars__WEBPACK_IMPORTED_MODULE_0__["default"].swiperText, {
  centeredSlides: true,
  loop: true,
  slidesPerView: 'auto',
  spaceBetween: 10,
...
var swiperPic = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](_vars__WEBPACK_IMPORTED_MODULE_0__["default"].swiperPic, {
  centeredSlides: true,
  loop: true,
  slidesPerView: 'auto',
  spaceBetween: 0,
...
var swiperTeam = new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](_vars__WEBPACK_IMPORTED_MODULE_0__["default"].swiperTeam, {
  centeredSlides: true,
  loop: true,
  slidesPerView: 'auto',
  spaceBetween: 0,
...
var rules1 = [{
  ruleSelector: '.form-contacts__name',
  rules: [{
    rule: 'minLength',
    value: 3,
    errorMessage: 'Имя минимум 3 знака'
  }, {
    rule: 'required',
    value: true,
  ...
  ruleSelector: '.form-contacts__email',
  email: true,
  emailError: 'Введите корректный телефон',
  rules: [{
    rule: 'required',
    value: true,
  ...
  ruleSelector: '.form-contacts__phone',
  tel: true,
...
var afterForm = function afterForm() {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].overlay.classList.add('overlay--visible');
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].popupWrapper.classList.add('popup__wrapper--visible');
  (0,_functions_disable_scroll__WEBPACK_IMPORTED_MODULE_1__.disableScroll)();
};

(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_5__.validateForms)('.form-contacts__container', rules1, afterForm);

if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].popupBtn) {
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].popupBtn.addEventListener('click', function () {
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].overlay.classList.remove('overlay--visible');
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].popupWrapper.classList.remove('popup__wrapper--visible');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  swiperText: document.querySelector('.hero__slider--text'),
  swiperPic: document.querySelector('.hero__slider--pic'),
  swiperTeam: document.querySelector('.swiper__team'),
...
if (document.querySelector('.cart-middle__delete')) {
  document.querySelector('.cart-middle__delete').addEventListener('click', function (event) {
    event.currentTarget.closest('.cart-middle__list').remove();
    document.querySelector('.cart-total__top span').textContent = '$0';
    document.querySelector('.cart-total__total span').textContent = '$0';
  });
} // filter


var productItem = document.querySelectorAll(".product__item");
var filtersItem = document.querySelectorAll(".filters__item");

if (document.querySelector('.filters__list')) {
  document.querySelector('.filters__list').addEventListener('click', function (event) {
    // event.preventDefault();
    filtersItem.forEach(function (el) {
      el.classList.remove('filters__item--active');
    });

    if (!event.target.classList.contains('filters__item--active')) {
      event.target.classList.add('filters__item--active');
    } else {
      event.target.classList.remove('filters__item--active');
    }
